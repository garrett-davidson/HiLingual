...
public class User {
    ...
    public ArrayList<Language> getKnownlanguages() { return knownlanguages; }
    public ArrayList<Language> getLearningLanguages() { return learningLanguages; }
    public ArrayList<User> getBlockedUsers() { return blockedUsers; }
    public ArrayList<User> getUsersChattedWith() { return usersChattedWith; }
